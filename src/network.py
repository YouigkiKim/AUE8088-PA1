...
class SimpleClassifier(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        f1_score = torch.mean(self.f1_score(scores, y))
        self.log_dict({'loss/train': loss, 'accuracy/train': accuracy, 'mean_f1_score/train' : f1_score},
    ...
    def validation_step(self, batch, batch_idx):
        ...
        accuracy = self.accuracy(scores, y)
        f1_score = torch.mean(self.f1_score(scores, y))
        self.log_dict({'loss/val': loss, 'accuracy/val': accuracy, 'mean_f1_score/val' : f1_score},
                      on_step=False, on_epoch=True, prog_bar=True, logger=True)
